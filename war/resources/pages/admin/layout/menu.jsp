...
<nav class="navbar navbar-default" role="navigation">
	<ul class="nav nav-tabs nav-stacked nav-pills">
		...
		<li name="users"><a href="#"><fmt:message key="labels.menu.admin.link.users"/></a></li>
		...
		<c:choose>
			<c:when test="${empty UserContext.user}">
				<li><button onclick="window.location='${UserContext.loginUrl}'" type="button" class="btn btn-default navbar-btn"><fmt:message key="labels.header.portal.login"/></button></li>
			</c:when>	
			<c:otherwise>
